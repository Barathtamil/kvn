    ...
    <div className="pt-20">
      ...
      <section className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Try Our <span className="text-gradient from-indigo-600 to-purple-600">Free Sample</span> Editing
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 md:p-12 rounded-3xl shadow-2xl">
            {isSubmitted ? (
              ...
              <>
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 mb-2">Get Your Free Sample Edit</h2>
                  <p className="text-gray-600">Enter your email to receive upload instructions</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      } focus:border-indigo-500 focus:outline-none transition-colors text-lg`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              What's <span className="text-gradient from-indigo-600 to-purple-600">Included</span>
            </h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              How It <span className="text-gradient from-indigo-600 to-purple-600">Works</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="text-center relative">
                ...
                <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full text-white text-2xl font-bold mb-4 shadow-lg z-10">
                  {step.number}
                </div>
      ...
      <section className="py-20 bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Frequently Asked <span className="text-gradient from-indigo-600 to-purple-600">Questions</span>
            </h2>
          </div>
